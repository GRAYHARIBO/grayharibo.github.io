...
<div class="message">
Undergraduate Research Intern, Sep. 2023 – Jun. 2024  <br>
...
1. **Internal Occlusion Mechanism**:
   - For this approach, I explored methods to reduce the vessel’s effective cross-sectional area from within. Specifically, I investigated using a **low-melting point alloy (LMPA)** and origami structures to occlude the SVC, inspired by techniques used in [Hwang et al. (2022)](https://www.science.org/doi/10.1126/scirobotics.abg2171). I also experimented with **shape memory alloys (SMA)**, which exhibit contraction when heated.
...
- **Silicone-Based Structure**: The actuator structure was made from silicone for its high elasticity and thermal endurance, inspired by work from [Martinez et al. (2012)](https://onlinelibrary.wiley.com/doi/full/10.1002/adfm.201102978?casa_token=W9Mpzsw7140AAAAA%3AVKvrGHiEDEJZVj1LTN6b6JrKyHV0rWQ88CFEm76LMQ81luisheb0aZrKfVSOTv3xHGtDRspn4oju5QI) Silicone provided the necessary flexibility to withstand the volume changes induced by the phase transition.
...
<img src="/images/robotics_conference.jpg" alt="Korea Robotics Society Conference 2024" style="width: 50%; margin: 0.5rem; border-radius: 5px;">
